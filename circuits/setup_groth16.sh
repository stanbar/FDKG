...
# snarkjs groth16 setup build/partial_decryption_share/partial_decryption_share.r1cs ptau/powersOfTau28_hez_final_13.ptau groth16_pkey.zkey
# mv groth16_pkey.zkey build/partial_decryption_share/
# snarkjs zkey export verificationkey build/partial_decryption_share/groth16_pkey.zkey build/partial_decryption_share/groth16_vkey.json
